...
<head>
    ...
    <title>Compare || Hiraola - Jewellery eCommerce Bootstrap 5 Template</title>
                    ...
                    <table class="table table-bordered table-hover mb-0">
                        <tbody>
                            <tr>
                                ...
                                <td class="compare-column-productinfo">
                                    <div class="compare-pdoduct-image">
                                        ...
                                        <a href="cart.php" class="hiraola-compare_btn">
                            ...
                            <tr>
                                <th>Product Name</th>
                                <td>
                                    <h5 class="compare-product-name"><a href="single-product.php">Toe Rings</a>
                                    </h5>
                                </td>
                                <td>
                                    <h5 class="compare-product-name"><a href="single-product.php">Exquisite Rings</a></h5>
                                </td>
                            </tr>
                            <tr>
                                <th>Description</th>
