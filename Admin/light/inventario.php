 <div class="block-header">
     <div class="row clearfix">
         ...
         <div class="col-md-6 col-sm-12 text-right hidden-xs" data-bs-toggle="modal" data-bs-target="#addproduct">
                         ...
                         <table class="table table-hover js-basic-example dataTable table-custom spacing5">
                             ...
                             <tbody>
                                 <tr>
                                     ...
                                     <td>$320,800</td>
                                     <td>
                                         <button type="button" class="btn btn-info mb-2" data-bs-toggle="modal" data-bs-target="#seeproduct">
                                             <i class="fa fa-info-circle"></i>
                                             <span>Ver</span>
                                         </button>
                                         <button type="button" class="btn btn-warning mb-2" data-bs-toggle="modal" data-bs-target="#addproduct">
