                ...
                <div class="tab-pane active" id="Home-icon">
                    <nav class="sidebar-nav sidebar-scroll">
                        <ul class="metismenu">
                            ...
                            <li><a href="app-chat.html"><i class="icon-notebook"></i><span>Cantactos</span></a></li>
                            ...
                            <li class="header"><span>Configuración</span></li>
                            <li><a href="page-profile.html"><i class="icon-user"></i><span>Mi Perfil</span></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
