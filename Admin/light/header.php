    ...
    <div id="left-sidebar" class="sidebar">
        <div class="sidebar_icon">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item active"><a class="nav-link active" data-toggle="tab" href="#Home-icon"><i class="fa fa-dashboard"></i></a></li>                
                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Envelope-icon"><i class="fa fa-envelope"></i></a></li>
                <li class="nav-item"><a class="nav-link" href="#Profile-icon" class="icon-menu" data-toggle="tab"><i class="fa fa-user"></i></a></li>
                <li class="nav-item"><a class="nav-link" href="#Setting-icon" class="icon-menu" data-toggle="tab"><i class="fa fa-cog"></i></a></li>
                <!-- <li class="nav-item"><a class="nav-link" href="/PVSupplies/index.php" class="icon-menu"><i class="fa fa-power-off"></i></a></li> -->
                ...
                <div class="tab-pane active" id="Home-icon">
                    <nav class="sidebar-nav sidebar-scroll">
                        <ul class="metismenu" id="menu">
                            ...
                            <!-- <li data-page="reportes"><a href="#" data-page="reportes"><i class="icon-bar-chart" data-page="reportes"></i><span data-page="reportes">Reportes</span></a></li> -->
                            
                            
                            <!-- <li class="header">old</li>
                ...
                <div class="tab-pane" id="Envelope-icon">
                    <nav class="sidebar-nav sidebar-scroll">
                        ...
                        <ul class="metismenu" id="menu1">
                            <li data-page="compose"><a href="#" data-page="compose" class="btn btn-danger btn-block mb-3" style="color: white; font-weight: bold;"><span data-page="compose">Nuevo Mensaje</span></a></li>
                            <li class="active" data-page="inbox"><a href="#" data-page="inbox"><i class="icon-drawer" data-page="inbox"></i><span data-page="inbox">Inbox</span><span class="badge badge-primary float-right" data-page="inbox">6</span></a></li>
