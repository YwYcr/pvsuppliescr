            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="banner-item img-hover_effect">
                            <a href="shop-left-sidebar.php">
                                <img class="img-full" src="assets/images/banner/1_3.jpg" alt="Hiraola's Banner">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="banner-item img-hover_effect">
                            <a href="shop-left-sidebar.php">
                                <img class="img-full" src="assets/images/banner/1_4.jpg" alt="Hiraola's Banner">
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="hiraola-product_slider">
                                ...
                                <div class="single_product">
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info">
                                            <h6><a class="product-name" href="single-product.php">Pendant, Made of White
                                                    Pl...</a></h6>
                                            <div class="price-box">
                            ...
                            <div class="slide-item">
                                <div class="single_product">
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info">
                                            <h6><a class="product-name" href="single-product.php">Swirl 1 Medium Pendant
                                                    La...</a></h6>
                                            <div class="price-box">
                                                <span class="new-price">£120.80</span>
                                            </div>
                            ...
                            <div class="slide-item">
                                <div class="single_product">
                                    ...
                                    <div class="hiraola-product_content">
                                        <div class="product-desc_info">
                                            <h6><a class="product-name" href="single-product.php">JWDA Penant Lamp Brshed</a>
                                            </h6>
                                            <div class="price-box">
                                ...
                                <div class="hiraola-product-tab_slider-2">
                                    ...
                                    <div class="slide-item">
                                        <div class="single_product">
                                            ...
                                            <div class="hiraola-product_content">
                                                <div class="product-desc_info">
                                                    <h6><a class="product-name" href="single-product.php">Pwoly and Bark Eames
                                                            Styl...</a></h6>
                                                    <div class="price-box">
                                ...
                                <div class="hiraola-product-tab_slider-2">
                                    ...
                                    <div class="slide-item">
                                        <div class="single_product">
                                            ...
                                            <div class="hiraola-product_content">
                                                <div class="product-desc_info">
                                                    <h6><a class="product-name" href="single-product.php">George Nelson
                                                            Sunburst Cl...</a></h6>
                                                    <div class="price-box">
                                    ...
                                    <div class="slide-item">
                                        <div class="single_product">
                                            ...
                                            <div class="hiraola-product_content">
                                                <div class="product-desc_info">
                                                    <h6><a class="product-name" href="single-product.php">1 - 2 Person Outdoor
                                                            Camp...</a></h6>
                                                    <div class="price-box">
                                    ...
                                    <div class="slide-item">
                                        <div class="single_product">
                                            ...
                                            <div class="hiraola-product_content">
                                                <div class="product-desc_info">
                                                    <h6><a class="product-name" href="single-product.php">Puoly and Bark Eames
                                                            Styl...</a></h6>
                                                    <div class="price-box">
